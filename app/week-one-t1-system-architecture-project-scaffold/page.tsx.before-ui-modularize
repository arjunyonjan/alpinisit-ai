            ...
            <div className="flex items-center justify-between px-3 py-3 cursor-pointer hover:bg-blue-50/40" onClick={() => toggleItem(idx)}>
              ...
              {idx === 0 && title === "Low Level" && (
                <div className="flex gap-2 mr-2" onClick={(e) => e.stopPropagation()}>
                  <a href={`https://chatgpt.com/?q=${encodeURIComponent("AI Engineering Training > System Architecture and Project Scaffold - " + item)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Ask ChatGPT">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg" alt="ChatGPT" className="w-5 h-5" />
                  </a>
                  <a href={`https://www.google.com/search?udm=50&q=${encodeURIComponent("AI Engineering Training > System Architecture and Project Scaffold - " + item)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Search with Google AI">
                    <img src="https://cdn.simpleicons.org/googlegemini/4285F4" alt="Gemini" className="w-5 h-5" />
                  </a>
                  <a href={`https://chat.deepseek.com/search?q=${encodeURIComponent("AI Engineering Training > System Architecture and Project Scaffold - " + item)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Ask DeepSeek">
                  ...
                  return (
                    <div key={i} className="flex items-center justify-between text-sm text-gray-700 bg-gray-50 rounded-lg px-3 py-2 hover:bg-white hover:shadow-sm transition">
                      ...
                      <div className="flex gap-2">
                        <a href={`https://chatgpt.com/?q=${encodeURIComponent(fullContext)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Ask ChatGPT">
                          <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg" alt="ChatGPT" className="w-5 h-5" />
                        </a>
                        <a href={`https://www.google.com/search?udm=50&q=${encodeURIComponent(fullContext)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Search with Google AI">
                          <img src="https://cdn.simpleicons.org/googlegemini/4285F4" alt="Gemini" className="w-5 h-5" />
                        </a>
                        <a href={`https://chat.deepseek.com/search?q=${encodeURIComponent(fullContext)}`} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition" title="Ask DeepSeek">
                          <img src="https://cdn.simpleicons.org/deepseek/5661F6" alt="DeepSeek" className="w-5 h-5" />
                        </a>
                      </div>
                    </div>
