      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 rounded-[32px] border border-gray-200 bg-white p-10 shadow-sm">
          <div className="mb-5 flex items-center gap-4">
            ...
            <div>
              <h1 className="text-5xl font-black tracking-tight text-gray-900">Week 1</h1>
              <p className="mt-1 text-xl text-blue-600">AI Systems and Engineering Setup</p>
            </div>
          </div>
          <p className="max-w-4xl text-lg leading-8 text-gray-600">Foundations for production ready AI engineering systems including async APIs architecture validation observability debugging and multi provider LLM integration.</p>
        </div>
        <div className="mb-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm"><div className="mb-3 text-sm font-semibold uppercase tracking-wide text-blue-600">Planning</div><div className="text-2xl font-bold text-gray-900">Monday</div></div>
          <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm"><div className="mb-3 text-sm font-semibold uppercase tracking-wide text-blue-600">Learning and Implementation</div><div className="text-2xl font-bold text-gray-900">Tuesday to Thursday</div></div>
          <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm"><div className="mb-3 text-sm font-semibold uppercase tracking-wide text-blue-600">Preparation and Demo</div><div className="text-2xl font-bold text-gray-900">Friday</div></div>
        </div>
        <div className="mb-10 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="mb-6 flex items-center gap-3"><BookIcon /><h2 className="text-3xl font-bold text-gray-900">Topics</h2></div>
          <div className="grid gap-4 md:grid-cols-2">
            {topics.map((topic) => (
              <div key={topic} className="flex items-start gap-3 rounded-2xl border border-gray-100 bg-gray-50 p-4">
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="mb-8 flex items-center gap-3"><Workflow className="h-8 w-8 text-violet-600" /><h2 className="text-3xl font-bold text-gray-900">Team Tasks</h2></div>
          <div className="grid gap-6 lg:grid-cols-2">
            {tasks.map((task) => {
              const Icon = task.icon
              return (
                <div key={task.title} className="rounded-3xl border border-gray-200 bg-[#fcfcfc] p-6">
                  <div className="mb-5 flex items-center gap-4">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-100 text-blue-600"><Icon className="h-7 w-7" /></div>
